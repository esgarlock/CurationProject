...
CSV: [Most Recent Comparison Document](results/all_comparisions_2026-05-08.csv) (includes indexing methods and indexing revision date for gallery)  
CSV: [Titles and Abstracts for Gallery](gallerystuff/TitlesAbstracts_Changed.csv)  
